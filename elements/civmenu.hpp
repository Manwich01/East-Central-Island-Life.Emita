...
class button_restrain : RscButton        {idc = 6;x = 0.41; y = 0.53;w = 0.20; h = 0.04;text = "Restrain/Release";                 action = "[] execVM ""Scripts\Restrain.sqf""; closedialog 0";};
...
class button_warning : RscButton                  {x = 0.41; y = 0.73;w = 0.20; h = 0.04;text = "Give Warning";   action = "[7, ctrlText 69] execVM ""Scripts\civmenuinit.sqf""; closedialog 0";};
