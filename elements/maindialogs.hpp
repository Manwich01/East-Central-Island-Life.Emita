class civcamdialog
{
	...
	class submit : RscButton
	{
		...
		action = "[0,1,2,[""civcam"", call compile lbData [1, lbCurSel 1], sliderPosition 2]] execVM ""Scripts\copcams.sqf""; closeDialog 0";
	};
...
class wantedrelease
{
	...
	class submit : RscButton	
	{
		...
		action = "[(call compile lbData [1, lbCurSel 1]), (ctrlText 2), 0] execVM ""Scripts\wantedrelease.sqf""; closeDialog 0";	
	};
	...
	{			
		...
		action = "[(call compile lbData [11, lbCurSel 11])] execVM ""Scripts\setfree.sqf""; closeDialog 0";	
	};
	...
	{						
		...
		action = "[(call compile lbData [1, lbCurSel 1]), 0, 1] execVM ""Scripts\wantedrelease.sqf""; closeDialog 0";
	};
...
class gang_menu
{
	...
	class button_join : RscButton	
	{
		...
		action = "[0, 0, 0, [""join"", (lbData [202, (lbCurSel 202)])]] execVm ""core\client\gangs.sqf""; closedialog 0;";			
	};
	...
	class button_leave : RscButton	
	{
		...
		action = "[0, 0, 0, [""leave""]] execVm ""core\client\gangs.sqf""; closedialog 0;";
	};
	...
	class button_manage : RscButton
	{
		...
		action = "[0, 0, 0, [""gildenverwaltung""]] execVm ""core\client\maindialogs.sqf""; closedialog 0;";
	};
...
class gilde_gruenden
{
	...
	class submit : RscButton	
	{
		...
		action = "[0, 0, 0, [""create"", (ctrlText 1)]] execVm ""core\client\gangs.sqf""; closedialog 0;";
	};
...
class gilden_punktekaufdialog
{
	...
	class submit : RscButton
	{
		...
		text = $STRD_description_submit;
		action = "closedialog 0;";//[0,0,0,[""clientpunktekauf"", round(sliderposition 1)]] execVM ""Scripts\3432469.sqf""; 
	};
...
class gilde_verwaltung
{
	...
	class rauswerfen_submit : RscButton	
	{
		...
		action = "[0, 0, 0, [""kick"", (lbData [102, (lbCurSel 102)]), (lbCurSel 102)]] execVm ""core\client\gangs.sqf""; closedialog 0;";	
	};
	...
	class sperren_submit : RscButton
	{
		...
		action = "[0,0,0,[""allowjoin"", (lbData [201, (lbCurSel 201)]), (lbCurSel 201)]] execVM ""core\client\gangs.sqf""; closedialog 0;";	
	};
...
{			
	...
	action = "[0,1,2,[""ClientWahlc"", lbData [1, (lbCurSel 1)]]] execVM ""Scripts\chief.sqf""; closedialog 0";
};
	class cancel : RscButton		
	{							
		x = 0.42; 
...
class CopMenu
{
	...
	class button1 : RscButton
	{
		...
		action = "closedialog 0; [0,1,2,[""wantedrelease""]] execVM ""core\client\maindialogs.sqf"";";
	};
	...
	class button2 : RscButton
	{
		...
		text = "Civcam Menu";
		action = "closedialog 0; [0,1,2,[""civcam""]] execVM ""core\client\maindialogs.sqf"";";	
	};
	...
	class button3 : RscButton
	{
		...
		text = "Jailcam";
		action = "closedialog 0; [0,1,2,[""jailcam""]] execVM ""Scripts\copcams.sqf"";";
	};
	...
	class button4 : RscButton
	{
		...
		text = "Sat Cam";	
		action = "closedialog 0; [ [(getPos player select 0), (getPos player select 1), 200] ] execVM ""Scripts\satcam.sqf"";";
	};
	...
	{							
		...
		text = "Crime log";	
		action = "closedialog 0; [0,1,2,[""coplog""]] execVM ""core\client\maindialogs.sqf"";";	
	};
	...
	{			
		...
		action = "closedialog 0; [] execVM ""Scripts\copmarkers.sqf"";";
	};
