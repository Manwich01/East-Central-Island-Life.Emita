...
workplacejob_deliveryflagarray   = [workplacejob_deliveryflag1];
/* TODO: All these missing them mission.sqm
...
workplacejob_deliverynamearray   = ["Delivery Point 1", "Delivery Point 2", "Delivery Point 3", "Delivery Point 4", "Delivery Point 5", "Delivery Point 6", "Delivery Point 7", "Delivery Point 8", "Delivery Point 9", "Delivery Point 10"];
