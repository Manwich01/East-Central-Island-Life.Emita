...
_art     = _this select 1;         
//           D. bell      C. Miller  D.Viper   Agressor
Donate_id = ["129724358","1754630","24638022","70969478","","","","","","","","","","","","","","","","","","","","","","","",""];
...
if (_art == "add") then 
	...
	if(_license == "Donator_licence" and !(_uid in Donate_id)) exitWith { player groupChat "Restriced to Donators"};
