...
lbSetCurSel [99, 0];
lbSetCurSel [1, 0];
buttonSetAction [3,format["[""use"",  lbData [1, (lbCurSel 1)], ctrlText 501, lbData [99, (lbCurSel 99)]] execVM ""core\client\INVactions.sqf""; closedialog 0;"] ];
buttonSetAction [4,format["[""drop"", lbData [1, (lbCurSel 1)], ctrlText 501, lbData [99, (lbCurSel 99)]] execVM ""core\client\INVactions.sqf""; closedialog 0;"] ];
buttonSetAction [246,format["[""give"", lbData [1, (lbCurSel 1)], ctrlText 501, lbData [99, (lbCurSel 99)]] execVM ""core\client\INVactions.sqf""; closedialog 0;"] ];
