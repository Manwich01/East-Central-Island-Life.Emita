...
if (local_arrest == 1) then {player switchmove "civillying01"; waituntil {animationstate player == "civillying01"}; ["arrest", 20, player] execVM "core\client\civmenu.sqf";};
if (isdead == 1 and isciv) then {player setpos getpos deadcamlogic;[] execVM "core\client\rejoincamera.sqf";};
