...
//call compile format ['_hurenname = "%3" createUnit [getMarkerPos "hoespawn", group player, "%1huren%2 = this;this addEventHandler [""killed"", {[(_this select 1), %1] execVM ""core\client\workerkilled.sqf"";}]; this setVehicleVarName ""%1huren%2"";"]; _hurenname = %1huren%2;', rolestring, _hurennumber, _civ];

call compile format ['_hurenname = "%3" createUnit [getPosATL player, group player, "%1huren%2 = this;this addEventHandler [""killed"", {[(_this select 1), %1] execVM ""core\client\workerkilled.sqf"";}]; this setVehicleVarName ""%1huren%2"";"]; _hurenname = %1huren%2;', rolestring, _hurennumber, _civ];
