...
{ 
	...
	//==================================RESTRAIN=========================================
		...
		(format['server globalchat "%3 was handcuffed by %2";if (rolestring == "%1") then {execVM "core\client\Unrestrain.sqf";}', _coparrest, name player, name _coparrest]) call broadcast;
		};
	};
