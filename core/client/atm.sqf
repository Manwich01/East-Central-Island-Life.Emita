/* local_robbsperre is apart of bank robbing, I am guessing this isn't fully implemented
if (local_robbsperre == 1)  exitWith {
   player groupChat format [localize "STRS_bank_dialoge_robbsperre",(local_robbsperre_zeit call ISSE_str_IntToStr)]
};*/

if (!(createDialog "bank")) exitWith {
   hint "Dialog Error!";
};
...
buttonSetAction [10, format["[call compile lbData [1, lbCurSel 1], ctrlText 2, ""deposit""]  execVM ""core\client\transact.sqf""; closedialog 0;"] ];
buttonSetAction [11, format["[ctrlText 6,                          0,          ""withdraw""] execVM ""core\client\transact.sqf""; closedialog 0;"] ];
