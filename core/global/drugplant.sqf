...
if (_art == "Use") then 
{
	...
	if ((player distance marea1 < 150) or (player distance marea2 < 150) or (player distance marea3 < 150) or (player distance marea4 < 150)) then
	{
		...
		if (_Item == "MarijuanaSeed") then 
			...
			_plant setVehicleInit "this addaction [""Burn Marijuana"", ""core\global\core\global\DrugScript"", [""Burn"", ""Marijuana""],1,false,true,"""",""player distance _this <= 10""]";
			processInitCommands; 
			...
			sleep 120;		
			_plant setVehicleInit "this addaction [""Harvest Marijuana"", ""core\global\DrugScript"", [""Harvest"", ""Marijuana""],1,false,true,"""",""player distance _this <= 10""]";
			processinitcommands;
		...
		if (_Item == "HeroinSeed") then 
			...
			_plant setVehicleInit "this addaction [""Burn Heroin"", ""core\global\DrugScript"", [""Burn"", ""Heroin""],1,false,true,"""",""player distance _this <= 10""]";
			_plant setPos [getPos _plant select 0, getPos _plant select 1, 0];
			processInitCommands; 
			sleep 120;
			player groupChat "Poppy Plant will be ready in 120 seconds"; 
			sleep 120;		
			_plant setVehicleInit "this addaction [""Harvest Heroin"", ""core\global\DrugScript"", [""Harvest"", ""Heroin""],1,false,true,"""",""player distance _this <= 10""]";
			processinitcommands;
			//_plant setPos [getPos _plant select 0, getPos _plant select 1, 0];
		...
		if (_Item == "CocaineSeed") then 
			...
			_plant setVehicleInit "this addaction [""Burn Cocaine"", ""core\global\DrugScript"", [""Burn"", ""Cocaine""],1,false,true,"""",""player distance _this <= 10""]";
			_plant setPos [getPos _plant select 0, getPos _plant select 1, 0];
			processInitCommands; 
			sleep 120;
			player groupChat "Coca Plant Nearly will be ready in 120 seconds"; 
			sleep 120;		
			_plant setVehicleInit "this addaction [""Harvest Cocaine"", ""core\global\DrugScript"", [""Harvest"", ""Cocaine""],1,false,true,"""",""player distance _this <= 10""]";
			processinitcommands;
			//_plant setPos [getPos _plant select 0, getPos _plant select 1, 0];
