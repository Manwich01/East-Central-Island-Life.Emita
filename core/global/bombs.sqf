...
if (_art == "init") then {
   ...
   if (isServer) then {["server"] execVM "core\global\bombs.sqf";};
   ["client"] execVM "core\global\bombs.sqf";
};
      ...
      _skipWait = false;
		for [{_i=0}, {_i < (count INV_LocalBombArray)}, {_i=_i+1}] do {
			...
			
         {
				_v = vehicle player;
				switch _item do {
					case "fernzuenderbombe":      { _a1 = _v addAction [localize "STRS_inv_item_vehiclebomb_action_deactivate",  "core\global\noscript.sqf", format["[""config"", ""defuse"", ""%1"", ""%2""] execVM ""core\global\bombs.sqf"";", _item, _id ]];_actionArr = _actionArr + [_a1];};
					case "zeitzuenderbombe":      { _a1 = _v addAction [localize "STRS_inv_item_vehiclebomb_action_deactivate", "core\global\noscript.sqf",  format["[""config"", ""defuse"", ""%1"", ""%2""] execVM ""core\global\bombs.sqf"";", _item, _id ]];_a2 = _v addAction [localize "STRS_inv_item_vehiclebomb_action_changetimer", "core\global\noscript.sqf", format["[""config"", ""Timer"",  ""%1"", ""%2""] execVM ""core\global\bombs.sqf"";", _item, _id ]];_actionArr = _actionArr + [_a1, _a2];};
					case "aktivierungsbombe":     { _a1 = _v addAction [localize "STRS_inv_item_vehiclebomb_action_deactivate", "core\global\noscript.sqf", format["[""config"", ""defuse"", ""%1"", ""%2""] execVM ""core\global\bombs.sqf"";", _item, _id ]];_actionArr = _actionArr + [_a1];};
					case "geschwindigkeitsbombe": {_a1 = _v addAction [localize "STRS_inv_item_vehiclebomb_action_deactivate", "core\global\noscript.sqf", format["[""config"", ""defuse"", ""%1"", ""%2""] execVM ""core\global\bombs.sqf"";", _item, _id ]];_actionArr = _actionArr + [_a1];};
				};
			};
...
if (_art == "use") then {
	...
	if (_item == "zeitzuenderbombe") then {
		...
		buttonSetAction [4, "[""plant"", ""zeitzuenderbombe"", sliderPosition 1] execVM ""core\global\bombs.sqf""; closedialog 0;"];
	...
	if (_item == "aktivierungsbombe") then {
		["plant", "aktivierungsbombe"] execVM "core\global\bombs.sqf";
	};
	...
	if (_item == "geschwindigkeitsbombe") then {
		...
		buttonSetAction [4, "[""plant"", ""geschwindigkeitsbombe"", sliderPosition 1, sliderPosition 8] execVM ""core\global\bombs.sqf""; closedialog 0;"];
	...
	if (_item == "fernzuenderbombe") then {
		["plant", "fernzuenderbombe"] execVM "core\global\bombs.sqf";
	};
