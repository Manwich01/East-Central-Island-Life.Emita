...
hint "Dialog Error!";
 ...
 {
 [""schluessel"",  (INV_VehicleArray select lbCurSel 1), lbCurSel 1] execVM ""core\global\keys.sqf"";
};
...
"];
 ...
 {
 [""dropschluessel"", (INV_VehicleArray select lbCurSel 1), lbCurSel 1] execVM ""core\global\keys.sqf"";
};
...
"];
 ...
 {
 [""schluesseluebergabe"", (INV_VehicleArray select lbCurSel 1), lbCurSel 1] execVM ""core\global\keys.sqf"";
};
