...
if (_art == "GrafikEinstellungen") then {
   ["closedialog 0; [""Einstellungen""] execVM ""Scripts\settings.sqf"";"] execVM "Scripts\3442919.sqf";
};
...
if (_art == "ItemList") then {
   _handler = ["closedialog 0; [""Einstellungen""] execVM ""Scripts\settings.sqf"";", "Back"] execVM "Scripts\740153.sqf";
