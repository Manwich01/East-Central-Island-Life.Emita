...
(format ["if (rolestring == ""%1"") then {[""licheck"", ""%2""] execVM ""core\client\civmenu.sqf"";}", _civmenu_civ, rolestring]) call broadcast;
...
(format ["if (rolestring == ""%1"") then {[""inventcheck"", ""%2""] execVM ""core\client\civmenu.sqf"";}", _civmenu_civ, rolestring]) call broadcast;
...
(format ["if (rolestring == ""%1"") then {[""stealmoney"", ""%2""] execVM ""core\client\civmenu.sqf"";};", _civmenu_civ, rolestring]) call broadcast;
...
(format ["if (player == %1) then {[""drugs"", %2] execVM ""core\client\civmenu.sqf"";};", _civmenuciv, player]) call broadcast;
...
(format ["if (player == %1) then {[""disarm""] execVM ""core\client\civmenu.sqf"";};", _civmenuciv]) call broadcast;
...
format ["if (player == %1) then {[""arrest"", %2, %3] execVM ""core\client\civmenu.sqf"";};", _civmenu_civ, _dauer, player] call broadcast;
...
(format ["if (player == %1) then {[""ticket"", %2, %3] execVM ""core\client\civmenu.sqf"";}; server globalchat format[localize ""STRS_civmenu_ticket_globalchat"", name %1, %2, name %3];", _civmenuciv, (_strafe call ISSE_str_IntToStr), player]) call broadcast;
